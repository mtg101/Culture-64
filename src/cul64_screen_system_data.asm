...
SCREEN_SYSTEM_BG_COL_SPEED
    !byte 0    
SCREEN_SYSTEM_PULSAR_SPEED_LUT
    !byte %11111111, %01111111, %00111111, %00011111, %00001111, %00000111, %00011111, %00001111
SCREEN_SYSTEM_ASTEROID_SPEED
    !byte 0    
SCREEN_SYSTEM_ASTEROID_SPEED_LUT
    !byte %11111111, %01111111, %00111111, %00011111, %00001111, %00000111, %00011111, %00001111
SCREEN_SYSTEM_PULSAR_SPEED
    !byte 0    
SCREEN_SYSTEM_PULSAR_FRAME
    !byte 0    
SCREEN_SYSTEM_PULSAR_FRAME_COLS
    !byte CYAN
    !byte WHITE 
    !byte CYAN
    !byte BLACK 
